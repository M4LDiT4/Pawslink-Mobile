...
Event _eventDeserialize(
  ...
  object.timeInMinutes = reader.readLong(offsets[3]);
...
extension EventQueryFilter on QueryBuilder<Event, Event, QFilterCondition> {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> timeInMinutesEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> timeInMinutesGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> timeInMinutesLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> timeInMinutesBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension EventQuerySortBy on QueryBuilder<Event, Event, QSortBy> {
  ...
  QueryBuilder<Event, Event, QAfterSortBy> sortByTimeInMinutes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeInMinutes', Sort.asc);
    });
  }

  QueryBuilder<Event, Event, QAfterSortBy> sortByTimeInMinutesDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension EventQuerySortThenBy on QueryBuilder<Event, Event, QSortThenBy> {
  ...
  QueryBuilder<Event, Event, QAfterSortBy> thenByTimeInMinutes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeInMinutes', Sort.asc);
    });
  }

  QueryBuilder<Event, Event, QAfterSortBy> thenByTimeInMinutesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timeInMinutes', Sort.desc);
    });
  }
...
extension EventQueryWhereDistinct on QueryBuilder<Event, Event, QDistinct> {
  ...
  QueryBuilder<Event, Event, QDistinct> distinctByTimeInMinutes() {
    return QueryBuilder.apply(this, (query) {
...
extension EventQueryProperty on QueryBuilder<Event, Event, QQueryProperty> {
  ...
  QueryBuilder<Event, int, QQueryOperations> timeInMinutesProperty() {
    return QueryBuilder.apply(this, (query) {
