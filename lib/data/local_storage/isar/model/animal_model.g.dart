...
void _animalSerialize(
  ...
  writer.writeBool(offsets[1], object.isSterilized);
...
Animal _animalDeserialize(
  ...
  object.id = id;
  object.isSterilized = reader.readBool(offsets[1]);
...
extension AnimalQueryFilter on QueryBuilder<Animal, Animal, QFilterCondition> {
  ...
  QueryBuilder<Animal, Animal, QAfterFilterCondition> isSterilizedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension AnimalQuerySortBy on QueryBuilder<Animal, Animal, QSortBy> {
  ...
  QueryBuilder<Animal, Animal, QAfterSortBy> sortByIsSterilized() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSterilized', Sort.asc);
    });
  }

  QueryBuilder<Animal, Animal, QAfterSortBy> sortByIsSterilizedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AnimalQuerySortThenBy on QueryBuilder<Animal, Animal, QSortThenBy> {
  ...
  QueryBuilder<Animal, Animal, QAfterSortBy> thenByIsSterilized() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSterilized', Sort.asc);
    });
  }

  QueryBuilder<Animal, Animal, QAfterSortBy> thenByIsSterilizedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSterilized', Sort.desc);
    });
  }
...
extension AnimalQueryWhereDistinct on QueryBuilder<Animal, Animal, QDistinct> {
  ...
  QueryBuilder<Animal, Animal, QDistinct> distinctByIsSterilized() {
    return QueryBuilder.apply(this, (query) {
...
extension AnimalQueryProperty on QueryBuilder<Animal, Animal, QQueryProperty> {
  ...
  QueryBuilder<Animal, bool, QQueryOperations> isSterilizedProperty() {
    return QueryBuilder.apply(this, (query) {
